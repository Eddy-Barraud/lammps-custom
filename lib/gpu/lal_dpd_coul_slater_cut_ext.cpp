/***************************************************************************
                                 lal_dpd_coul_slater_cut_ext.cpp
                             -------------------
                            Eddy BARRAUD (IFPEN/Sorbonne)

  Functions for LAMMPS access to dpd/coul/slater/cut acceleration routines.
...
static DPDCoulSlaterCut<PRECISION,ACC_PRECISION> DPDCMF;

// ---------------------------------------------------------------------------
// Allocate memory on host and device and copy constants to device
// ---------------------------------------------------------------------------
int dpd_coul_slater_cut_gpu_init(const int ntypes, double **host_cutsq, double **host_a0,
...
void dpd_coul_slater_cut_gpu_update_coeff(int ntypes, double **host_a0, double **host_gamma,
